                        ...
                        foreach (var noeud in noeudList)
                        {
                            if (noeud.Latitude != null && noeud.Longitude != null)
                            {
                                markers.Add(new NodeModel
                                {
                                    ...
                                    Visible = (noeud.Type.Value == 1 && noeud.secteur.parcelle.exploitation.Climat.Value) ? true 
                                               : (noeud.Type.Value == 2 && noeud.secteur.parcelle.exploitation.Sol.Value) ? true
                                               : (noeud.Type.Value == 3 && noeud.secteur.parcelle.exploitation.Culture.Value) ? true
                                               : (noeud.Type.Value == 4 && noeud.secteur.parcelle.exploitation.Irrigation.Value) ? true
                                               : false,
                                    Icon = (noeud.Type.Value == 1 && noeud.secteur.parcelle.exploitation.Climat.Value) ? "../../Content/images/rouge.png"
                                            : (noeud.Type.Value == 2 && noeud.secteur.parcelle.exploitation.Sol.Value) ? "../../Content/images/orange.png"
                                            : (noeud.Type.Value == 3 && noeud.secteur.parcelle.exploitation.Culture.Value) ? "../../Content/images/vert.png"
                                            : (noeud.Type.Value == 4 && noeud.secteur.parcelle.exploitation.Irrigation.Value) ? "../../Content/images/bleu.png"
                                            : "",
                                });
