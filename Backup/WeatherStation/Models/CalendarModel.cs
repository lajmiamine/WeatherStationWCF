...
namespace WeatherStation.Models
{
    ...
    public interface ICalendarService
    {
        ...
        List<CalendarModel> GetCalendarByIdParcelOneDay(int idParcel, string startTime, bool fromMonth);
    ...
    public class CalendarService : ICalendarService
    {
        ...
        public List<CalendarModel> GetCalendarByIdParcelOneDay(int idParcel, string startTime, bool fromMonth)
        {
            DateTime startDate;
            if (!fromMonth)
            {
